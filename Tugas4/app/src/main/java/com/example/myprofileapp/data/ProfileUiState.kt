...
data class ProfileUiState(
    // Data Profile Asli
    val name: String = "Muhammad Dzaky",
    val bio: String = "Mahasiswa Teknik Informatika ITERA yang tertarik pada Web Developer.",
    val email: String = "muhammad.123140039@student.itera.ac.id",
    val phone: String = "08989174990",
